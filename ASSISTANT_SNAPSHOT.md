...
- **Default branch**: main
- **Latest commit**: 3f32128 — LLM parity: add route_decision tool + server guardrail to never downgrade below router; fallback to OptionA on downgrade
- **Updated (America/Chicago)**: 2025-09-29 21:45 CT
